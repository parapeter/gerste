...
For `[HTTPS-URLS]` you can only ad `https URLs` and for `[TOR-URLS]` you are forced to enter a `.onion` URL.<br/>
...
EXAMPLES
       ...
       gerste -t
              Synchronizes system time through the Tor network.
